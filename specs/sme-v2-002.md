...
# After each item:
GOEXPERIMENT=simd go1.26rc2 test ./hwy/contrib/nn/...
GOEXPERIMENT=simd go1.26rc2 test ./hwy/contrib/matmul/...

# Benchmarks:
GOEXPERIMENT=simd go1.26rc2 test -bench=BenchmarkSDPA -benchmem ./hwy/contrib/nn/...
GOEXPERIMENT=simd go1.26rc2 test -bench=BenchmarkQKVDense -benchmem ./hwy/contrib/nn/...
GOEXPERIMENT=simd go1.26rc2 test -bench=BenchmarkBlockedMatMul -benchmem ./hwy/contrib/matmul/...
GOEXPERIMENT=simd go1.26rc2 test -bench=BenchmarkMatMulKLast -benchmem ./hwy/contrib/matmul/...
